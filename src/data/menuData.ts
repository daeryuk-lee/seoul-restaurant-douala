...
export const menuData: Record<string, MenuItem[]> = {
  ...
  specialite: [
    {
      ...
      desc: { fr: '8 pcs', ko: '8개', en: '8 pcs', zh: '8个' },
      price: '5 000 Fcfa',
    },
    {
  ...
  friture: [
    ...
    },
    {
      ...
      desc: { fr: 'Ailes de poulet frites, sauce légèrement piquante et sucrée (6 pcs)', ko: '매콤달콤한 소스의 닭날개 튀김 (6개)', en: 'Fried chicken wings in sweet & mildly spicy sauce (6 pcs)', zh: '甜辣酱炸鸡翅 (6个)' },
      price: '7 500 Fcfa', spicy: 1,
    },
  ],
  riz_ragout: [
    {
