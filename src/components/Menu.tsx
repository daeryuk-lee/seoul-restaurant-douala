  ...
  return (
    <section id="menu" className="py-28 bg-[#0d0d0d] text-gray-200 relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative h-48 sm:h-56 mb-10 rounded-xl overflow-hidden border border-[#D4AF37]/20">
          <img
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center px-4">
              <p className="text-[9px] uppercase tracking-[0.35em] text-[#D4AF37]/70 mb-2">Selection</p>
              <h3 className="text-xl sm:text-3xl font-serif text-white/90 tracking-wide">
                {t(activeCategory?.labelKey || '')}
              </h3>
            </div>
          </div>
          <div className="absolute left-3 right-3 top-3 border-t border-[#D4AF37]/35"></div>
          <div className="absolute left-3 right-3 bottom-3 border-b border-[#D4AF37]/35"></div>
